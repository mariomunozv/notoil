...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { name: @discount.name, product_id: @discount.product_id, quantity: @discount.quantity, user_id: @discount.user_id }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { name: @discount.name, product_id: @discount.product_id, quantity: @discount.quantity, user_id: @discount.user_id }
    assert_redirected_to discount_path(assigns(:discount))
  end
